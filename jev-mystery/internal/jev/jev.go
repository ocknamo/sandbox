...
//
// This file is a copy of jev-nostr/internal/jev. Each service in this repo is
// its own module, and Go will not let one module import another's internal
// package, so the client is duplicated rather than shared. It is a thin
