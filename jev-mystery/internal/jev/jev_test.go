...
// This client is a copy of jev-nostr's, and its full test suite lives there.
// What is kept here is what this service depends on and a fake Asker cannot
// catch: that a real answer decodes, and that a rate limit is survived.
