...
//
// This file is a copy of jev-mystery/internal/jev, which is itself a copy of
// jev-nostr's. Each service in this repo is its own module, and Go will not
// let one module import another's internal package, so the client is
// duplicated rather than shared. It is a thin
// wrapper over one endpoint and changes about as often as that endpoint does.
package jev
